...
namespace HRIS_Common
{
    ...
    class CommonDB
    {
        ...
        public string CONST_CURRENTROW = "C";
        public string CONST_HISTORICALROW = "H";
        public string CONST_FUTUREROW = "F";
        public string CONST_APPR_STAT_NEW = "N";
        public string CONST_APPR_STAT_SUBMITTED = "S";
        public string CONST_APPR_STAT_PENDING = "C";
        public string CONST_APPR_STAT_REVIEWED = "R";
        public string CONST_APPR_STAT_APPROVED = "F";
        public string CONST_APPR_STAT_LVL1APPROVED = "1";
        public string CONST_APPR_STAT_LVL2APPROVED = "2";
        public string CONST_APPR_STAT_DISAPPROVED = "D";
        public string CONST_APPR_STAT_CANCELLED = "L";
        public string CONST_APPR_STAT_NEW_DESCR = "New";
        public string CONST_APPR_STAT_PENDING_DESCR = "Cancel Pending";
        public string CONST_APPR_STAT_SUBMITTED_DESCR = "Submitted";
        public string CONST_APPR_STAT_VIEWING = "X";
        public string CONST_APPR_STAT_VIEWING_DESCR = "NO_STATUS";
        public string CONST_WORDENCRYPTOR = "userprofile";

        public string GLOBAL_user_id = null;
        public string BODY_LINE = "";
        public Byte[] GLOBAL_image_upload_byte = null;

        public string DEFAULT_BUDGET_CODE = "";
        public string DEFAULT_EMP_TYPE = "";
        public string DEFAULT_DEPARTMENT_CODE = "";
        ...
        //***********************************************************************************************************************
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("@par_budget_code2", SqlDbType.VarChar).Value = parmvalue3;
                cmd.Parameters.Add("@par_employement_type", SqlDbType.VarChar).Value = parmvalue2;
