<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cTransactionsApprover.aspx.cs" Inherits="HRIS_eAdmin.View.cTransactionsApprover" %>
            ...
            <ContentTemplate>
                ...
                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content" style="background-image:linear-gradient(white, lightblue)">
                        ...
                        <div class="modal-body" runat="server" style="margin:10px;">
                                <div class="row" runat="server">
                                    <div class="col-12">
                                        <asp:UpdatePanel ID="UpdateDescr" runat="server">
                                            <ContentTemplate>
                                                <asp:Label ID="Label1" runat="server" Text="Transaction:" Font-Bold="True"></asp:Label>
                                                <asp:TextBox ID="txtb_trans_descr" MaxLength="100" runat="server" Width="100%" CssClass="form-control form-control-sm" Enabled="false" Font-Bold="True"></asp:TextBox>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                    <div class="col-12" style="margin-top:10px;">
                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:DropDownList ID="ddl_empl_name" runat="server" CssClass="form-control form-control-sm" AppendDataBoundItems="true" AutoPostBack="True"  OnSelectedIndexChanged="ddl_empl_name_SelectedIndexChanged" Width="100%"> </asp:DropDownList>   
                                    ...
                                    <div class="col-12" style="margin-top:10px;">
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            <ContentTemplate>
                                                <asp:Label ID="Label5" runat="server" Text="Sub-Department:" Font-Bold="True"></asp:Label>
                                    ...
                                    <div class="col-12" style="margin-top:10px;">
                                        <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                                            <ContentTemplate>
                                                <asp:Label ID="Label6" runat="server" Text="Division:" Font-Bold="True"></asp:Label>
                                                ...
                                                <asp:Label ID="Label7" runat="server" CssClass="lbl_required" Text=""></asp:Label>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                    <div class="col-12" style="margin-top:10px;">
                                        <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                                            <ContentTemplate>
                                                <asp:Label ID="Label8" runat="server" Text="Section:" Font-Bold="True"></asp:Label>
                                    ...
                                    <div class="col-5" style="margin-top:10px;">
                                        <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                            <ContentTemplate>
                                                <asp:Label ID="Label3" runat="server" Text="Authority:" Font-Bold="True"></asp:Label>
                                                <asp:DropDownList ID="ddl_workflow_authority" runat="server" CssClass="form-control form-control-sm" AppendDataBoundItems="true" AutoPostBack="True"  Width="100%">
                                                    <asp:ListItem Text="Reviewer" Selected="True" Value="0" />
                                                    <asp:ListItem Text="Level 1 Approver"  Value="1" />
                                                    <asp:ListItem Text="Level 2 Approver" Value="2" />
                                                    <asp:ListItem Text="Final Approver" Value="3" />
                                                </asp:DropDownList>   
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                    <div class="col-7" style="margin-top:10px;">
                                        <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                                            <ContentTemplate>
                                                 <asp:Label ID="Label10" runat="server" Text="With SS Review/Approval?" Font-Bold="True"></asp:Label>
                                                 <asp:CheckBox ID="chkbox_with_ss" runat="server" Font-Bold="True" style="word-spacing:3px;letter-spacing:2px;" Text="&nbsp;Yes" Width="100%" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                    </div>
                            ...
                            <div class="row" style="margin-bottom:10px">
                                ...
                                <div class="col-6">
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:DropDownList ID="ddl_transaction_descr" runat="server" CssClass="form-control form-control-sm" AppendDataBoundItems="true" AutoPostBack="True"  OnSelectedIndexChanged="ddl_transaction_descr_SelectedIndexChanged" Width="80%"> </asp:DropDownList>   
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-2 text-right">
                                    <asp:UpdatePanel ID="UpdatePanel10" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                        ...
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="ddl_transaction_descr" />
                                        </Triggers>
                                    </asp:UpdatePanel>
                                </div>
                            </div>
                                ...
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="AUTHORITY" SortExpression="workflow_authority_descr">
                                                    <ItemTemplate>
                                                        <%# Eval("workflow_authority_descr") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="35%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="center" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("transaction_code") + ", " + Eval("empl_id") + ", " + Eval("transaction_descr") %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("transaction_code") + ", " + Eval("empl_id") + ", " + Eval("transaction_descr") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
