<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cTransactionsReference.aspx.cs" Inherits="HRIS_eAdmin.View.cTransactionsReference" %>
                    ...
                    <div class="modal-content" style="background-image:linear-gradient(white, lightblue)">
                        ...
                        <div class="row" runat="server">
                                <div class="form-group col-md-12" >
                                            <asp:Label ID="Label1"  runat="server" Text="Transaction Code:" Font-Bold ="true"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_transaction_code" runat="server" Width="30%" CssClass="form-control" Enabled ="false"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                    </div>                            
                                <div class="form-group col-md-12">
                                    <asp:Label ID="Label3" runat="server" Text="Transaction Description:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_transaction_descr"  runat="server"  MaxLength="50"  Width="100%" CssClass="form-control"></asp:TextBox>
                                            <asp:Label ID="LblRequired1" CssClass="text-danger" runat="server" Text=""></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                               <div class="form-group col-md-12">
                                    <asp:Label ID="Label6" runat="server" Text="Level of Approval:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddl_level_of_approval" runat="server" CssClass="form-control-sm" AppendDataBoundItems="true" AutoPostBack="True"  Width="30%"> 
                                                    <asp:ListItem Text="1 Level"  Selected ="True" Value="1" />
                                                    <asp:ListItem Text="2 Levels"  Value="2" />
                                                    <asp:ListItem Text="3 Levels"  Value="3" />
                                            </asp:DropDownList>   
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                               <div class="form-group col-md-12">
                                    <asp:Label ID="Label7" runat="server" Text="With Reviewer:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                        <ContentTemplate>
                                                <asp:DropDownList ID="ddl_with_reviewer" runat="server" CssClass="form-control-sm" AppendDataBoundItems="true" AutoPostBack="True"  Width="30%">
                                                    <asp:ListItem Text="Yes" Selected="True" Value="True" />
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            >
                                            <Columns>
                                                <asp:TemplateField HeaderText="CODE" SortExpression="transaction_code">
                                                    <ItemTemplate>
                                                        <%# Eval("transaction_code") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="15%" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("transaction_code") %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("transaction_code") + ", " + Eval("transaction_descr") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
