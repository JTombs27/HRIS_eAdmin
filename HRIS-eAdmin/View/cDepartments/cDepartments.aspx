<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cDepartments.aspx.cs" Inherits="HRIS_eAdmin.View.cDepartments"%>
                ...
                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content modal-content-add-edit">
                        ...
                        <div class="row" runat="server">
                                <div class="col-3">
                                     <asp:Label ID="Label14" runat="server" CssClass="font-weight-bold" Text="Dept. Code:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_department_code" runat="server" Width="100%" CssClass="form-control text-center" Enabled ="false"></asp:TextBox>
                                            <asp:TextBox ID="tbx_effective_date" runat="server" Width="100%" CssClass="form-control" Enabled ="false" Visible="False"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-9">
                                    <asp:Label ID="Label3" runat="server" CssClass="font-weight-bold" Text="Department Short Name:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_department_short_name"  runat="server"  MaxLength="30"  Width="100%" CssClass="form-control"></asp:TextBox>
                                            <asp:Label ID="LblRequired0" CssClass="lbl_required" runat="server" Text=""></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-6">
                                    <asp:Label ID="Label2" runat="server" CssClass="font-weight-bold" Text="Department Name #1:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_department_name1" runat="server" MaxLength="100"   Width="100%" CssClass="form-control" TextMode="MultiLine" Rows="1"></asp:TextBox>
                                            <asp:Label ID="LblRequired1" CssClass="lbl_required" runat="server" Text=""></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                               <div class="col-6">
                                    <asp:Label ID="Label4" runat="server" CssClass="font-weight-bold" Text="Department Name #2:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_department_name2"  runat="server"  MaxLength="255"  Width="100%" CssClass="form-control" TextMode="MultiLine" Rows="1"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-3">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_sort_order_dept" runat="server"  MaxLength="3" Width="100%" CssClass="form-control text-center"></asp:TextBox>
                                            <asp:Label ID="LblRequired2" CssClass="lbl_required"  runat="server" Text=""></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                               <div class="col-9">
                                    <asp:Label ID="Label7" runat="server" CssClass="font-weight-bold" Text="Print Group:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                        <ContentTemplate>
                                                <asp:DropDownList ID="ddl_print_group" runat="server" CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="True"  Width="100%">
                                                    <asp:ListItem Text="Governor's Office" Selected="True" Value="1" />
                                                    <asp:ListItem Text="Vice-Governor's Office" Value="2" />
                                                </asp:DropDownList>   
                               ...
                               <div class="col-12">
                                ...
                                <div class="col-6">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_designation_head1"  runat="server"  MaxLength="100"  Width="100%"  CssClass="form-control"  TextMode="MultiLine" Rows="1"></asp:TextBox>
                               ...
                               <div class="col-6">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_designation_head2"  runat="server"  MaxLength="100" Width="100%" CssClass="form-control"  TextMode="MultiLine" Rows="1"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-12">
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <asp:Label ID="Label1" runat="server" CssClass="font-weight-bold" Text="Function Name:"></asp:Label>
                                            <asp:DropDownList runat="server" CssClass="form-control" ID="ddl_function_code"></asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                            </script>
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            >
                                            <Columns>
                                                <asp:TemplateField HeaderText="CODE" SortExpression="department_code">
                                                    <ItemTemplate>
                                                        <%# Eval("department_code") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="05%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="DEPARTMENT NAME" SortExpression="department_name1">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="DEPARTMENT HEAD" SortExpression="employee_name_format1">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("department_code") + ", " + Eval("effective_date") %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("department_code") + ", " + Eval("effective_date") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
