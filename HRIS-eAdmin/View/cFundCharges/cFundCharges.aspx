<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cFundCharges.aspx.cs" Inherits="HRIS_eAdmin.View.cFundCharges"%>
                ...
                <div class="modal fade" id="deleteRec">
                    ...
                    <!-- Modal body -->
                            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                <ContentTemplate>
                                    <div class="modal-body">
                                        <i class="fa-5x fa fa-question"></i>
                ...
                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content modal-content-add-edit">
                        ...
                        <div class="row" runat="server">
                                <div class="col-2">
                                     <asp:Label ID="Label14" runat="server" CssClass="font-weight-bold" Text="Fund Code:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_fund_code" runat="server" Width="100%" CssClass="form-control text-center" Enabled ="false"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-10">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_fund_short_description" runat="server"  MaxLength="30"  Width="100%" CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="col-12">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_fund_description" TextMode="MultiLine" Height = "60px" runat="server" MaxLength="255"   Width="100%" CssClass="form-control"></asp:TextBox>
                               ...
                               <div class="col-12">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                        <ContentTemplate>
                                                <asp:DropDownList ID="ddl_print_type" runat="server" CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="True"  Width="50%">
                                                    <asp:ListItem Text="General Purpose" Selected="True" Value="0" />
                                                    <asp:ListItem Text="Plantilla" Value="1" />
                                                    <asp:ListItem Text="Other Purposes" Value="2" />
                                                </asp:DropDownList>   
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                               <div class="col-12">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel17" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddl_fundhead_name" runat="server" CssClass="form-control" AppendDataBoundItems="true" OnSelectedIndexChanged="ddl_fundhead_name_SelectedIndexChanged" AutoPostBack="True" Width="100%"> </asp:DropDownList> 
                               ...
                               <div class="col-12">
                                    <asp:Label ID="Label1" runat="server" CssClass="font-weight-bold" Text="Accountant:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddl_accnt_name" runat="server" CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="True"  Width="100%"> </asp:DropDownList> 
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-12">
                                    <asp:Label ID="Label6" runat="server" CssClass="font-weight-bold" Text="Accountant Designation #1:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_designation_accountant1" runat="server"  MaxLength="100"  Width="100%"  CssClass="form-control" ></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                               <div class="col-12">
                                    <asp:Label ID="Label11" runat="server" CssClass="font-weight-bold" Text="Accountant Designation #2:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_designation_accountant2" runat="server"  MaxLength="100" Width="100%" CssClass="form-control"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
...
<%--            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="tbx_designation_head1" />
            </Triggers>--%>
        </asp:UpdatePanel>
     <div class="col-12">
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            >
                                            <Columns>
                                                <asp:TemplateField HeaderText="CODE" SortExpression="fund_code">
                                                    <ItemTemplate>
                                                        <%# Eval("fund_code") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="08%" />
                                                ...
                                                <asp:TemplateField HeaderText="FUND CHARGES" SortExpression="fund_description">
                                                    <ItemTemplate>
                                                        <%# Eval("fund_description") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="40%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("fund_code") %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("fund_code") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
