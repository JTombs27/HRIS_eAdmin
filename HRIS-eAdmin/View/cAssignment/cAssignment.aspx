<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cAssignment.aspx.cs" Inherits="HRIS_eAdmin.View.cAssignment"%>
                    ...
                    <div class="modal-content" style="background-image:linear-gradient(white, lightblue)">
                        ...
                        <div class="row" runat="server">
                                <div class="form-group col-md-12" >
                                            <asp:Label ID="Label1" runat="server" Text="Assignment Code:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_assigment_code" runat="server" Width="12%" CssClass="form-control" Enabled ="false"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                    </div>                            
                                <div class="form-group col-md-12">
                                    <asp:Label ID="Label3" runat="server" Text="Assignment/Station:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_assignment_descr"  runat="server"  MaxLength="255"  TextMode="MultiLine" Rows="3" Width="100%" CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_short_description"  runat="server" MaxLength="30"   Width="100%" CssClass="form-control"></asp:TextBox>
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            >
                                            <Columns>
                                                <asp:TemplateField HeaderText="CODE" SortExpression="assignment_code">
                                                    <ItemTemplate>
                                                        <%# Eval("assignment_code") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="5%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="ASSIGNMENT/STATION" SortExpression="assignment_descr">
                                                    <ItemTemplate>
                                                        <%# Eval("assignment_descr") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="45%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="left" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="SHORT DESCRIPTION" SortExpression="assignment_short_descr">
                                                    <ItemTemplate>
                                                        <%# Eval("assignment_short_descr") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="25%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="left" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("assignment_code") + ", " + Eval("assignment_descr") %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("assignment_code") + ", " + Eval("assignment_descr") %>'/>
                                                                <% }
                                                                %>
