<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cMunicipality.aspx.cs" Inherits="HRIS_eAdmin.View.cMunicipality.cMunicipality" %>
                    ...
                    <div class="modal-content" style="background-image:linear-gradient(white, lightblue)">
                        ...
                        <div class="row" runat="server">
                                <div class="form-group col-md-12" >
                                            <asp:Label ID="Label1" runat="server" CssClass="font-weight-bold" Text="Municipality Code:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_municipalitycode" runat="server" Width="15%" CssClass="form-control text-center" Enabled ="false"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                    </div>                            
                                <div class="form-group col-md-12">
                                    <asp:Label ID="Label3" runat="server" CssClass="font-weight-bold" Text= "Municipality Name:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_municipalityname" runat="server" Width="100%" MaxLength="100" CssClass="form-control"></asp:TextBox>
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            >
                                            <Columns>
                                                <asp:TemplateField HeaderText="CODE" SortExpression="municpality_code">
                                                    <ItemTemplate>
                                                        <%# Eval("municipality_code") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="10%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="MUNICIPALITY NAME" SortExpression="municpality_name">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="PROVINCE NAME" SortExpression="municpality_name">
                                                    <ItemTemplate>
                                                        <%# Eval("province_name") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="30%" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                ...
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("municipality_code") %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("municipality_code") + ", " + Eval("municipality_name") %>'/>
                                                                <% }
                                                                    else
                                                                    {
                                                                %>
