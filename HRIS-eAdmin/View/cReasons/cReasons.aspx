<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cReasons.aspx.cs" Inherits="HRIS_eAdmin.View.cReasons.cReasons" %>
                    ...
                    <div class="modal-content" style="background-image:linear-gradient(white, lightblue)">
                        ...
                        <div class="row" runat="server">
                                <div class="form-group col-md-12" >
                                            <asp:Label ID="Label1" CssClass="font-weight-bold"  runat="server" Text="Reasons code:" Font-Bold ="true"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_reason_code" maxlength="2" runat="server" Width="30%" CssClass="form-control" Enabled ="false"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                    </div>                            
                                <div class="form-group col-md-12">
                                    <asp:Label ID="Label3" runat="server" CssClass="font-weight-bold" Text="Reasons Description:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_reasons_description"  runat="server"  MaxLength="50"  Width="100%" CssClass="form-control"></asp:TextBox>
                            ...
                            <div class="form-group col-md-12">
                                    <asp:Label ID="Label2" runat="server" CssClass="font-weight-bold" Text="Reasons Subject Description:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_reasons_subject_description"  runat="server"  MaxLength="50"  Width="100%" CssClass="form-control"></asp:TextBox>
                             ...
                             <div class="form-group col-md-12">
                                    <asp:Label ID="Label5" runat="server" CssClass="font-weight-bold" Text="Transaction Description"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddl_transaction_descr" value="" runat="server"  Width="100%" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddl_transaction_SelectedIndexChanged"></asp:DropDownList>
                                            <asp:Label ID="LblRequired3" CssClass="text-danger" runat="server" Text=""></asp:Label>
                                      </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            >
                                            <Columns>
                                                <asp:TemplateField HeaderText="CODE" SortExpression="reason_code">
                                                    <ItemTemplate>
                                                        <%# Eval("reason_code") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="10%" />
                                                ...
                                                <asp:TemplateField HeaderText="REASON DESCRIPTION" SortExpression="reason_descr">
                                                    <ItemTemplate>
                                                        <%# Eval("reason_descr") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="20%" />
                                             ...
                                             <asp:TemplateField HeaderText="REASON REPORT SUBJECT" SortExpression="reason_report_subject">
                                                    <ItemTemplate>
                                                        <%# Eval("reason_report_subject") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="40%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="left" />
                                                 ...
                                                 <asp:TemplateField HeaderText="TRANSACTION DESCRIPTION" SortExpression="transaction_descr">
                                                    <ItemTemplate>
                                                        <%# Eval("transaction_descr") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="40%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="left" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                ...
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("reason_code")%>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("reason_code") + ", " + Eval("reason_descr") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
