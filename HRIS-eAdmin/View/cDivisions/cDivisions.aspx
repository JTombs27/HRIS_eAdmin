<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cDivisions.aspx.cs" Inherits="HRIS_eAdmin.View.cDivisions.cDivisions" %>
                ...
                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content modal-content-add-edit">
                        ...
                        <div class="row" runat="server">
                                <div class="col-3">
                                     <asp:Label ID="Label14" runat="server" CssClass="font-weight-bold" Text="Div. Code:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_division_code" runat="server" Width="100%" CssClass="form-control text-center" Enabled ="false"></asp:TextBox>
                                            <asp:TextBox ID="tbx_effective_date" runat="server" Width="100%" CssClass="form-control" Enabled ="false" Visible="False"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-9">
                                    <asp:Label ID="Label3" runat="server" CssClass="font-weight-bold" Text="Division Short Name:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_division_short_name"  runat="server"  MaxLength="30"  Width="100%" CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="col-12">
                                    <asp:Label ID="Label11" runat="server" CssClass="font-weight-bold" Text="Division Name #1:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_division_name1"  runat="server"  MaxLength="100"  Width="100%"  CssClass="form-control" ></asp:TextBox>
                                ...
                                <div class="col-12">
                                    <asp:Label ID="Label13" runat="server" CssClass="font-weight-bold" Text="Division Name #2:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_division_name2"  runat="server"  MaxLength="100"  Width="100%"  CssClass="form-control" ></asp:TextBox>
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            >
                                            <Columns>
                                                <asp:TemplateField HeaderText="CODE" SortExpression="division_code">
                                                    <ItemTemplate>
                                                        <%# Eval("division_code") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="05%" />
                                                ...
                                                <asp:TemplateField HeaderText="DIVISION NAME" SortExpression="division_name1">
                                                    <ItemTemplate>
                                                        <%# Eval("division_name1") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="60%" />
                                                ...
                                                <asp:TemplateField HeaderText="DIVISION HEAD" SortExpression="employee_name_format1">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("division_code") + ", " + Eval("effective_date") %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("division_code") + ", " + Eval("effective_date") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
