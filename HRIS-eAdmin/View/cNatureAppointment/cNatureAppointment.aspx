<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cNatureAppointment.aspx.cs" Inherits="HRIS_eAdmin.View.cNatureAppointment" %>
                        ...
                        <div class="row" runat="server">
                                <div class="col-12">
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label"><strong>Code:</strong></label>
                                        <div class="col-12 col-md-3">
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                <ContentTemplate>
                                                   <asp:TextBox ID="tbx_natureapp_code"  runat="server"  MaxLength="30"  Width="100%" CssClass="form-control form-control-sm"></asp:TextBox>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label"><strong>Description:</strong></label>
                                        <div class="col-12 col-md-9">
                                            <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                                                <ContentTemplate>
                                                    <asp:TextBox ID="tbx_natureapp_descr" runat="server"  MaxLength="50"  Width="100%" CssClass="form-control form-control-sm"></asp:TextBox>
                                ...
                                <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                    <ContentTemplate>
                                        <asp:GridView 
                                                ...
                                                >
                                                <Columns>
                                                    <asp:TemplateField HeaderText="CODE" SortExpression="natureappointment_code">
                                                        <ItemTemplate>
                                                            
                                                            &nbsp;&nbsp;<%# Eval("natureappointment_code")%>
                                                        </ItemTemplate>
                                                        <ItemStyle Width="8%" />
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="NATURE OF APPOINTMENT DESCRIPTION" SortExpression="holiday_name">
                                                        <ItemTemplate>
                                                            <%# Eval("natureappointment_descr") %>
                                                        </ItemTemplate>
                                                        <ItemStyle Width="82%" />
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <% 
                                                                        ...
                                                                        {
                                                                    %>
                                                                        <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("natureappointment_code") %>'/>
                                                                    ...
                                                                    <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                        {
                                                                    %>
                                                                        <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("natureappointment_code") + ", " + Eval("natureappointment_code") %>'/>
                                                                    <% }
                                                                    %>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
