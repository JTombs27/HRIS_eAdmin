...
{
    public partial class cSections : System.Web.UI.Page
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            if (Session["ea_user_id"] != null)
            {
                ...
                {
                    InitializePage();
                    ViewState["SortField"] = "section_code";
        ...
        {
            dataListGrid = MyCmn.RetrieveData("sp_sections_tbl_list");
        ...
        private void ClearEntry()
        {
            ...
            tbx_sec_code.Text = "";
            tbx_section_short_name.Text = "";
            tbx_section_name1.Text = "";
            tbx_section_name2.Text = "";
            tbx_designation_head2.Text = "";
            ddl_dept_name.SelectedIndex = 0;
            ddl_subdept_name.SelectedIndex = 0;
            ddl_div_name.SelectedIndex = 0;
            tbx_sort_order.Text = "";
            tbx_sec_code.ReadOnly = false;
        ...
        private void AddNewRow()
        {
            ...
            if (dtRowCont > -1)
            {
                ...
                lastCode = lastRow["section_code"].ToString();
            }
        ...
        private void InitializeTable()
        {
            ...
            dtSource.Columns.Add("section_short_name", typeof(System.String));
            dtSource.Columns.Add("section_name1", typeof(System.String));
            dtSource.Columns.Add("section_name2", typeof(System.String));
            dtSource.Columns.Add("department_code", typeof(System.String));
            dtSource.Columns.Add("subdepartment_code", typeof(System.String));
            dtSource.Columns.Add("sort_order_sect", typeof(System.String));
        ...
        {
            dtSource.TableName = "sections_tbl";
            dtSource.Columns.Add("action", typeof(System.Int32));
            dtSource.Columns.Add("retrieve", typeof(System.Boolean));
            string[] col = new string[] { "effective_date", "section_code" };
        ...
        public void btnDelete_Command(object sender, CommandEventArgs e)
        {
            ...
            string deleteExpression = "section_code = '" + dept_cd2 + "' AND CONVERT(date, effective_date) = CONVERT(date,'" + eff_dt2.ToString().Trim() + "')";
            string deleteExpression1 = "section_code = '" + dept_cd2 + "' AND effective_date = '" + eff_dt2.ToString().Trim() + "'";

            MyCmn.DeleteBackEndData("sections_tbl", "WHERE " + deleteExpression);
        ...
        {
            string[] commandArgs = e.CommandArgument.ToString().Split(new char[] { ',' });
            string sectioncode = commandArgs[0];
            string eff_dt2 = commandArgs[1];
            string editExpression = "section_code = '" + sectioncode + "' AND effective_date = '" + eff_dt2.ToString().Trim() + "'";
            ...
            nrow["section_code"] = sectioncode;
            nrow["action"] = 2;
            nrow["retrieve"] = true;
            dtSource.Rows.Add(nrow);
            FieldValidationColorChanged(false, "ALL");

            tbx_sec_code.Text = sectioncode;
            tbx_effective_date.Text = eff_dt2;
            tbx_section_short_name.Text = row2Edit[0]["section_short_name"].ToString();
            tbx_section_name1.Text = row2Edit[0]["section_name1"].ToString();
            tbx_section_name2.Text = row2Edit[0]["section_name2"].ToString();
            ...
            tbx_sort_order.Text = row2Edit[0]["sort_order_sect"].ToString();
            ddl_depHead_name.SelectedValue = row2Edit[0]["empl_id"].ToString();
            ddl_div_name.SelectedValue = row2Edit[0]["division_code"].ToString();
            ...
            tbx_sec_code.ReadOnly = true;
            tbx_section_short_name.Focus();
            LabelAddEdit.Text = "Edit Record: " + tbx_section_short_name.Text.Trim();
        ...
        public void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (IsDataValidated())
            {
                if (saveRecord == MyCmn.CONST_ADD)
                {
                    ...
                    dtSource.Rows[0]["section_code"] = tbx_sec_code.Text.ToString();
                    dtSource.Rows[0]["section_short_name"] = tbx_section_short_name.Text.ToString();
                    dtSource.Rows[0]["section_name1"] = tbx_section_name1.Text.ToString();
                    dtSource.Rows[0]["section_name2"] = tbx_section_name2.Text.ToString();
                    ...
                    dtSource.Rows[0]["sort_order_sect"] = tbx_sort_order.Text.ToString();
                    dtSource.Rows[0]["division_code"] = ddl_div_name.SelectedValue.ToString();
                ...
                if (saveRecord == MyCmn.CONST_ADD || saveRecord == MyCmn.CONST_EDIT)
                {
                    ...
                    if (saveRecord == MyCmn.CONST_ADD)
                    {
                        ...
                        nrow["section_code"] = tbx_sec_code.Text.ToString();
                        nrow["section_short_name"] = tbx_section_short_name.Text.ToString();
                        nrow["section_name1"] = tbx_section_name1.Text.ToString();
                        nrow["section_name2"] = tbx_section_name2.Text.ToString();
                        nrow["department_code"] = ddl_dept_name.SelectedValue.ToString();
                        nrow["subdepartment_code"] = ddl_subdept_name.SelectedValue.ToString();
                        nrow["sort_order_sect"] = tbx_sort_order.Text.ToString();
                        nrow["division_code"] = ddl_div_name.SelectedValue.ToString();
                    ...
                    {
                        string editExpression = "section_code = '" + tbx_sec_code.Text.ToString() + "' AND effective_date = '" + tbx_effective_date.Text.ToString().Trim() + "'";
                        DataRow[] row2Edit = dataListGrid.Select(editExpression);
                        row2Edit[0]["effective_date"] = tbx_effective_date.Text.ToString();
                        row2Edit[0]["section_code"] = tbx_sec_code.Text.ToString();
                        row2Edit[0]["section_short_name"] = tbx_section_short_name.Text.ToString();
                        row2Edit[0]["section_name1"] = tbx_section_name1.Text.ToString();
                        row2Edit[0]["section_name2"] = tbx_section_name2.Text.ToString();
                        ...
                        row2Edit[0]["sort_order_sect"] = tbx_sort_order.Text.ToString();
                        row2Edit[0]["division_code"] = ddl_div_name.SelectedValue.ToString();
        ...
        public void retaininfo() {
            ...
            if (tbx_search.Text != "") {
                ...
                string searchExpression = "section_code LIKE '%" + tbx_search.Text.Trim() + "%' OR section_name1 LIKE '%" + tbx_search.Text.Trim() + "%' OR employee_name_format1 LIKE '%" + tbx_search.Text.Trim() + "%'";

                DataTable dtSource1 = new DataTable();

                dtSource1.Columns.Add("effective_date", typeof(System.String));
                dtSource1.Columns.Add("section_code", typeof(System.String));
                dtSource1.Columns.Add("section_short_name", typeof(System.String));
                dtSource1.Columns.Add("section_name1", typeof(System.String));
                dtSource1.Columns.Add("section_name2", typeof(System.String));
                dtSource1.Columns.Add("department_code", typeof(System.String));
                dtSource1.Columns.Add("subdepartment_code", typeof(System.String));
                dtSource1.Columns.Add("sort_order_sec", typeof(System.String));
        ...
        //  BEGIN - JORGE RUSTOM VILLANUEVA- 01/29/2019 - Validate Dropdownlist for Salary Grade 
        //*********************************************************************************
        public void ddl_div_name_SelectedIndexChanged(object sender, EventArgs e)
        {

            if (ddl_div_name.SelectedValue.ToString() == "")
            {
                FieldValidationColorChanged(true, "ddl_div_name");
            }
            else
            {
                FieldValidationColorChanged(false, "ddl_div_name");
            }
            ddl_div_name.Focus();
        }
        //*************************************************************************
        ...
        //*************************************************************************
        //  BEGIN - JORGE RUSTOM VILLANUEVA- 01/29/2019 - Populate Combo list from Divisions Table
        //*************************************************************************
        private void RetrieveBindingDiv()
        {
            ddl_div_name.Items.Clear();
            DataTable dtEmpList = MyCmn.RetrieveData("sp_divisions_tbl_list");

            ddl_div_name.DataSource = dtEmpList;
            ddl_div_name.DataTextField = "division_name1";
            ddl_div_name.DataValueField = "division_code";
            ddl_div_name.DataBind();
            ListItem li = new ListItem("-- Select Here --", "");
            ddl_div_name.Items.Insert(0, li);
        }
        ...
        private bool IsDataValidated()
        {
            ...
            if (tbx_section_name1.Text == "")
            {
                FieldValidationColorChanged(true, "tbx_section_name1");
                tbx_section_name1.Focus();
        ...
        public void FieldValidationColorChanged_Actual(bool pMode, string pObjectName, string err_msg)
        {
            if (pMode)
                switch (pObjectName)
                {
                    ...
                    case "tbx_section_name1":
                        {
                            LblRequired1.Text = err_msg;
                            tbx_section_name1.BorderColor = Color.Red;
                            break;
                        }
            ...
            else if (!pMode)
            {
                switch (pObjectName)
                {
                    case "tbx_section_name1":
                        {
                            LblRequired1.Text = "";
                            tbx_section_short_name.BorderColor = Color.LightGray;
                            break;
                        }
                    case "ddl_dept_name":
                        {
                    ...
                    case "ALL":
                        {
                            ...
                            LblRequired5.Text = "";
                            tbx_section_short_name.BorderColor = Color.LightGray;
                            tbx_section_name1.BorderColor = Color.LightGray;
                            ddl_dept_name.BorderColor = Color.LightGray;
