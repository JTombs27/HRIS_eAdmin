<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cSections.aspx.cs" Inherits="HRIS_eAdmin.View.cSections.cSections" %>
                ...
                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content modal-content-add-edit">
                        ...
                        <div class="row" runat="server">
                                <div class="col-3">
                                     <asp:Label ID="Label14" runat="server" CssClass="font-weight-bold" Text="Sec. Code:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_sec_code" runat="server" Width="100%" CssClass="form-control text-center" Enabled ="false"></asp:TextBox>
                                            <asp:TextBox ID="tbx_effective_date" runat="server" Width="100%" CssClass="form-control" Enabled ="false" Visible="False"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-9">
                                    <asp:Label ID="Label3" runat="server" CssClass="font-weight-bold" Text="Section Short Name:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_section_short_name"  runat="server"  MaxLength="30"  Width="100%" CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="col-12">
                                    <asp:Label ID="Label11" runat="server" CssClass="font-weight-bold" Text="Section Name #1:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_section_name1"  runat="server"  MaxLength="100"  Width="100%"  CssClass="form-control" ></asp:TextBox>
                                ...
                                <div class="col-12">
                                    <asp:Label ID="Label13" runat="server" CssClass="font-weight-bold" Text="Section Name #2:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_section_name2"  runat="server"  MaxLength="100"  Width="100%"  CssClass="form-control" ></asp:TextBox>
                                ...
                                <div class="col-12">
                                    <asp:Label ID="Label1" runat="server" CssClass="font-weight-bold" Text="Department Name:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddl_dept_name" runat="server" CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="True"  OnSelectedIndexChanged="ddl_dept_name_SelectedIndexChanged" Width="100%"> </asp:DropDownList> 
                               ...
                               <div class="col-12">
                                    <asp:Label ID="Label4" runat="server" CssClass="font-weight-bold" Text="Sub Department Name:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddl_subdept_name" runat="server" CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="True"  OnSelectedIndexChanged="ddl_depHead_name_SelectedIndexChanged" Width="100%"> </asp:DropDownList> 
                                ...
                                <div class="col-12">
                                    <asp:Label ID="Label2" runat="server" CssClass="font-weight-bold" Text="Division Name:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddl_div_name" runat="server" CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="True"  OnSelectedIndexChanged="ddl_div_name_SelectedIndexChanged" Width="100%"> </asp:DropDownList> 
                                            <asp:Label ID="Label7" CssClass="lbl_required" runat="server" Text=""></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-3">
                                    <asp:Label ID="Label6" runat="server" CssClass="font-weight-bold" Text="Sort Order:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_sort_order" runat="server"  MaxLength="3" Width="100%" CssClass="form-control text-center"></asp:TextBox>
                               ...
                               <div class="col-12">
                                    <asp:Label ID="Label9" runat="server" CssClass="font-weight-bold" Text="Department Head:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel17" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddl_depHead_name" runat="server" CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="True"  OnSelectedIndexChanged="ddl_depHead_name_SelectedIndexChanged" Width="100%"> </asp:DropDownList> 
                                            <asp:Label ID="LblRequired6" CssClass="lbl_required" runat="server" Text=""></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-12">
                                    <asp:Label ID="Label5" runat="server" CssClass="font-weight-bold" Text="Head Designation #1:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_designation_head1"  runat="server"  MaxLength="100"  Width="100%"  CssClass="form-control" ></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                               <div class="col-12">
                                    <asp:Label ID="Label8" runat="server" CssClass="font-weight-bold" Text="Head Designation #2:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_designation_head2"  runat="server"  MaxLength="100" Width="100%" CssClass="form-control"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            >
                                            <Columns>
                                                <asp:TemplateField HeaderText="CODE" SortExpression="section_code">
                                                    <ItemTemplate>
                                                        <%# Eval("section_code") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="05%" />
                                                ...
                                                <asp:TemplateField HeaderText="SECTION NAME" SortExpression="section_name1">
                                                    <ItemTemplate>
                                                        <%# Eval("section_name1") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="60%" />
                                                ...
                                                <asp:TemplateField HeaderText="SECTION HEAD" SortExpression="employee_name_format1">
                                                    <ItemTemplate>
                                                        <%# Eval("employee_name_format1") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="30%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="left" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("section_code") + ", " + Eval("effective_date") %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("section_code") + ", " + Eval("effective_date") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
