<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cFunctions.aspx.cs" Inherits="HRIS_eAdmin.View.cFunctions"%>
                ...
                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content modal-content-add-edit">
                        ...
                        <div class="row" runat="server">
                                <div class="col-4">
                                     <asp:Label ID="Label14" runat="server" CssClass="font-weight-bold" Text="Function Code:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_function_code" runat="server" Width="100%" CssClass="form-control text-center" MaxLength="8"></asp:TextBox>
                                            <asp:Label ID="LblRequired0" CssClass="lbl_required" runat="server" Text=""></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-12">
                                    <asp:Label ID="Label3" runat="server" CssClass="font-weight-bold" Text="Function Short Name:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_function_shortname"  runat="server"  MaxLength="30"  Width="100%" CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        <div class="col-6">
                                            <asp:Label ID="Label2" runat="server" CssClass="font-weight-bold" Text="Function Name:"></asp:Label>
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                <ContentTemplate>
                                                    <asp:TextBox ID="tbx_function_name" runat="server" Width="100%" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                                    <asp:Label ID="LblRequired2" CssClass="lbl_required" runat="server" Text=""></asp:Label>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                        <div class="col-6">
                                            <asp:Label ID="Label4" runat="server" CssClass="font-weight-bold" Text="Function Details:"></asp:Label>
                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                <ContentTemplate>
                                                    <asp:TextBox ID="tbx_function_details"  runat="server"  Width="100%" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                ...
                                <div class="col-12">
                                    <asp:Label ID="Label6" runat="server" CssClass="font-weight-bold" Text="Function Program:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_function_program" runat="server"  Width="100%" CssClass="form-control" ></asp:TextBox>
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            >
                                            <Columns>
                                                <asp:TemplateField HeaderText="CODE" SortExpression="function_code">
                                                    <ItemTemplate>
                                                        <%# Eval("function_code") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="10%" />
                                                ...
                                                <asp:TemplateField HeaderText="FUNCTION NAME" SortExpression="function_name">
                                                    <ItemTemplate>
                                                        &nbsp;<%# Eval("function_name") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="50%" />
                                                ...
                                                <asp:TemplateField HeaderText="FUNCTION SHORT NAME" SortExpression="function_shortname">
                                                    <ItemTemplate>
                                                        &nbsp;<%# Eval("function_shortname") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="40%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="left" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("function_code")  %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("function_code") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
