<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cPositionContractDetails.aspx.cs" Inherits="HRIS_eAdmin.View.cPositionContractDetails"%>
                    ...
                    <div class="modal-content" style="background-image:linear-gradient(white, lightblue)">
                        ...
                        <div class="row" runat="server">
                                <div class="form-group col-md-12" >
                                            <asp:Label ID="Label1" runat="server" Text="Seq. No:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_position_seq_no" runat="server" Width="12%" CssClass="form-control" Enabled ="false"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                    </div>                            
                                <div class="form-group col-md-12">
                                    <asp:Label ID="Label3" runat="server" Text="Contract Details:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="tbx_position_contract_details"  TextMode="MultiLine" Height = "80px" runat="server"  MaxLength="255"  Width="100%" CssClass="form-control"></asp:TextBox>
                            ...
                            <div class="row" style="margin-bottom:10px">
                                ...
                                <div class="col-6">
                                        <asp:UpdatePanel ID="UpdatePanel26" runat="server">
                                            <ContentTemplate>
                                                    ...
                                                    <asp:DropDownList ID="ddl_position" Width="80%" runat="server" AutoPostBack="true" CssClass="form-control-sm" OnSelectedIndexChanged="ddl_position_SelectedIndexChanged" ></asp:DropDownList>
                                                </ContentTemplate>
                                        </asp:UpdatePanel>
                                  </div>
                                ...
                                <div class="col-2 text-right">
                                     <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                                        <ContentTemplate>
                                                <%--<asp:Button ID="btn_add"  runat="server" autoPostback="true" CssClass="btn btn-primary btn-sm add-icon icn" Text="Add" OnClick="btnAdd_Click"/>--%>
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            >
                                            <Columns>
                                                <asp:TemplateField HeaderText="SEQ NO." SortExpression="position_seq_no">
                                                    <ItemTemplate>
                                                        <%# Eval("position_seq_no") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="05%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="CONTRACT DETAILS" SortExpression="barangay_name">
                                                    <ItemTemplate>
                                                        <%# Eval("position_contract_details") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="85%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                ...
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("position_code")  + ", " + Eval("position_seq_no") %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("position_code") + ", " + Eval("position_seq_no") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
